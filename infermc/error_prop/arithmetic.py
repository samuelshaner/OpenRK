...
def add(a, b, corr=True, micro=True):
  if corr:
...
def sub(a, b, corr=True, micro=True):
  if corr:
...
def multiply_by_array(a, b, corr=True, micro=True):
  if corr:
...
def multiply_by_scalar(a, b, corr=True, micro=True):
  if corr:
...
def divide_by_array(a, b, corr=True, micro=True):
  if corr:
...
def divide_by_scalar(a, b, corr=True, micro=True):
  if corr:
