...
fuel1bin.setDopplerCoefficients([0.0, 0.0])
...
fuel1bo.setDopplerCoefficients([0.0, 0.0])
...
fuel2bin.setDopplerCoefficients([0.0, 0.0])
...
fuel2bo.setDopplerCoefficients([0.0, 0.0])
...
fuel2bino.setDopplerCoefficients([0.0, 0.0])
...
for i in xrange(9, 11):
    for cell_id in xrange(i*nx, (i+1)*nx):
        shape_mesh.setMaterial(reflector, cell_id)
...
for i in xrange(7, 9):
    for cell_id in xrange(i*nx, i*nx+7):
        shape_mesh.setMaterial(fuel2bin, cell_id)

for i in xrange(5, 7):
    for cell_id in xrange(i*nx+7, i*nx+9):
        shape_mesh.setMaterial(fuel2bin, cell_id)
#        shape_mesh.setMaterial(fuel2bino, cell_id)

for i in xrange(5):
    for cell_id in xrange(i*nx+7, i*nx+9):
        shape_mesh.setMaterial(fuel2bin, cell_id)

shape_mesh.setMaterial(fuel1bo, 6*nx)
shape_mesh.setMaterial(fuel1bo, 5*nx)

for i in xrange(5, 7):
    for cell_id in xrange(i*nx+5, i*nx+7):
        shape_mesh.setMaterial(fuel1bo, cell_id)

shape_mesh.setMaterial(fuel1bo, 0)
for cell_id in xrange(5, 7):
    shape_mesh.setMaterial(fuel1bo, cell_id)

shape_mesh.setMaterial(fuel2bo, 7*nx+7)
