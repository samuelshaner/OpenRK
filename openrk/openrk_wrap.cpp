...
SWIGINTERN PyObject *_wrap_vector_copy(PyObject *SWIGUNUSEDPARM(self), PyObject *args, PyObject *kwargs) {
  ...
  PyObject * obj2 = 0 ;
  char *  kwnames[] = {
    (char *) "vector_from",(char *) "vector_to",(char *) "length", NULL 
  };
  
  if (!PyArg_ParseTupleAndKeywords(args,kwargs,(char *)"OOO:vector_copy",kwnames,&obj0,&obj1,&obj2)) SWIG_fail;
  ...
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "vector_copy" "', argument " "2"" of type '" "double *""'"); 
  }
  arg2 = reinterpret_cast< double * >(argp2);
  ecode3 = SWIG_AsVal_int(obj2, &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "vector_copy" "', argument " "3"" of type '" "int""'");
  } 
