...
def matrixMultiplication(*args, **kwargs):
  return _openrk.matrixMultiplication(*args, **kwargs)
matrixMultiplication = _openrk.matrixMultiplication

def computeRMSE(*args, **kwargs):
  return _openrk.computeRMSE(*args, **kwargs)
...
class Clock(_object):
    ...
    def getStateName(self, *args, **kwargs): return _openrk.Clock_getStateName(self, *args, **kwargs)
...
class Material(_object):
    ...
    def setDecayConstant(self, *args, **kwargs): return _openrk.Material_setDecayConstant(self, *args, **kwargs)
    def setDelayedFraction(self, *args, **kwargs): return _openrk.Material_setDelayedFraction(self, *args, **kwargs)
...
class Matrix(_object):
    ...
    __del__ = lambda self : None;
    def incrementValue(self, *args, **kwargs): return _openrk.Matrix_incrementValue(self, *args, **kwargs)
    def clear(self): return _openrk.Matrix_clear(self)
    def printString(self): return _openrk.Matrix_printString(self)
    def transpose(self): return _openrk.Matrix_transpose(self)
    def getValue(self, *args, **kwargs): return _openrk.Matrix_getValue(self, *args, **kwargs)
    def getA(self): return _openrk.Matrix_getA(self)
    def getIA(self): return _openrk.Matrix_getIA(self)
    def getJA(self): return _openrk.Matrix_getJA(self)
    def getDiag(self): return _openrk.Matrix_getDiag(self)
    def getNumX(self): return _openrk.Matrix_getNumX(self)
    def getNumY(self): return _openrk.Matrix_getNumY(self)
    def getNumZ(self): return _openrk.Matrix_getNumZ(self)
    def getNumGroups(self): return _openrk.Matrix_getNumGroups(self)
    def getNumRows(self): return _openrk.Matrix_getNumRows(self)
    def getNNZ(self): return _openrk.Matrix_getNNZ(self)
    def setValue(self, *args, **kwargs): return _openrk.Matrix_setValue(self, *args, **kwargs)
...
class Vector(_object):
    ...
    __del__ = lambda self : None;
    def incrementValue(self, *args, **kwargs): return _openrk.Vector_incrementValue(self, *args, **kwargs)
    def incrementValues(self, *args, **kwargs): return _openrk.Vector_incrementValues(self, *args, **kwargs)
    def clear(self): return _openrk.Vector_clear(self)
    def scaleByValue(self, *args, **kwargs): return _openrk.Vector_scaleByValue(self, *args, **kwargs)
    def printString(self): return _openrk.Vector_printString(self)
    def copyTo(self, *args, **kwargs): return _openrk.Vector_copyTo(self, *args, **kwargs)
    def getValue(self, *args, **kwargs): return _openrk.Vector_getValue(self, *args, **kwargs)
    def getArray(self): return _openrk.Vector_getArray(self)
    def getNumX(self): return _openrk.Vector_getNumX(self)
    def getNumY(self): return _openrk.Vector_getNumY(self)
    def getNumZ(self): return _openrk.Vector_getNumZ(self)
    def getNumGroups(self): return _openrk.Vector_getNumGroups(self)
    def getNumRows(self): return _openrk.Vector_getNumRows(self)
    def getSum(self): return _openrk.Vector_getSum(self)
    def setValue(self, *args, **kwargs): return _openrk.Vector_setValue(self, *args, **kwargs)
    def setValues(self, *args, **kwargs): return _openrk.Vector_setValues(self, *args, **kwargs)
    def setAll(self, *args, **kwargs): return _openrk.Vector_setAll(self, *args, **kwargs)
...
class FunctionalMaterial(Material):
    ...
    def setDelayedFraction(self, *args, **kwargs): return _openrk.FunctionalMaterial_setDelayedFraction(self, *args, **kwargs)
    ...
    def setDelayedFractionByGroup(self, *args, **kwargs): return _openrk.FunctionalMaterial_setDelayedFractionByGroup(self, *args, **kwargs)
    ...
    def getDelayedFractionByGroup(self, *args, **kwargs): return _openrk.FunctionalMaterial_getDelayedFractionByGroup(self, *args, **kwargs)
    def getDelayedFractionTotal(self, *args, **kwargs): return _openrk.FunctionalMaterial_getDelayedFractionTotal(self, *args, **kwargs)
...
class GeometryDiffusion(Geometry):
    ...
    def uniformRefine(self, refine_x=1, refine_y=1, refine_z=1): return _openrk.GeometryDiffusion_uniformRefine(self, refine_x, refine_y, refine_z)
    ...
    def findCell(self, *args, **kwargs): return _openrk.GeometryDiffusion_findCell(self, *args, **kwargs)
...
class Solver(_object):
    ...
    __del__ = lambda self : None;
    def getAmpAMMatrix(self): return _openrk.Solver_getAmpAMMatrix(self)
    def getAmpMMatrix(self): return _openrk.Solver_getAmpMMatrix(self)
    ...
    def getGeometry(self): return _openrk.Solver_getGeometry(self)
    ...
    def generateAmplitudeMatrix(self): return _openrk.Solver_generateAmplitudeMatrix(self)
    ...
    def initializeClock(self): return _openrk.Solver_initializeClock(self)
...
class SolverDiffusion(Solver):
    ...
    def getGeometryDiffusion(self): return _openrk.SolverDiffusion_getGeometryDiffusion(self)
    ...
    def computeInitialShape(self, *args, **kwargs): return _openrk.SolverDiffusion_computeInitialShape(self, *args, **kwargs)
    def generateShapeMatrices(self, *args, **kwargs): return _openrk.SolverDiffusion_generateShapeMatrices(self, *args, **kwargs)
    ...
    def generateAdiabaticShapeMatrices(self): return _openrk.SolverDiffusion_generateAdiabaticShapeMatrices(self)
