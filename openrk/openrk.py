...
class Solver(_object):
    ...
    def getShape(self, state):
        return _openrk.Solver_getShape(self, state)

    def getAmplitude(self, state):
        return _openrk.Solver_getAmplitude(self, state)

    def getPower(self, state):
        return _openrk.Solver_getPower(self, state)

    def getCurrent(self, state):
        return _openrk.Solver_getCurrent(self, state)

    def getDifLinear(self, state):
        return _openrk.Solver_getDifLinear(self, state)

    def getDifNonlinear(self, state):
        return _openrk.Solver_getDifNonlinear(self, state)

    def getFrequency(self, state):
        return _openrk.Solver_getFrequency(self, state)
    ...
    def getShapeByValue(self, cell, group, state):
        return _openrk.Solver_getShapeByValue(self, cell, group, state)

    def getAmplitudeByValue(self, cell, group, state):
        return _openrk.Solver_getAmplitudeByValue(self, cell, group, state)

    def getPowerByValue(self, cell, state):
        return _openrk.Solver_getPowerByValue(self, cell, state)

    def getCurrentByValue(self, cell, group, side, state):
        return _openrk.Solver_getCurrentByValue(self, cell, group, side, state)

    def getDifLinearByValue(self, cell, group, side, state):
        return _openrk.Solver_getDifLinearByValue(self, cell, group, side, state)

    def getDifNonlinearByValue(self, cell, group, side, state):
        return _openrk.Solver_getDifNonlinearByValue(self, cell, group, side, state)

    def getFrequencyByValue(self, cell, group, state):
        return _openrk.Solver_getFrequencyByValue(self, cell, group, state)
    ...
    def setShapeByValue(self, value, cell, group, state):
        return _openrk.Solver_setShapeByValue(self, value, cell, group, state)

    def setAmplitudeByValue(self, value, cell, group, state):
        return _openrk.Solver_setAmplitudeByValue(self, value, cell, group, state)

    def setPowerByValue(self, value, cell, state):
        return _openrk.Solver_setPowerByValue(self, value, cell, state)

    def setFrequencyByValue(self, value, cell, group, state):
        return _openrk.Solver_setFrequencyByValue(self, value, cell, group, state)

    def setCurrentByValue(self, value, cell, group, side, state):
        return _openrk.Solver_setCurrentByValue(self, value, cell, group, side, state)

    def setFluxByValue(self, value, cell, group, state):
        return _openrk.Solver_setFluxByValue(self, value, cell, group, state)

    def setDifLinearByValue(self, value, cell, group, side, state):
        return _openrk.Solver_setDifLinearByValue(self, value, cell, group, side, state)

    def setDifNonlinearByValue(self, value, cell, group, side, state):
        return _openrk.Solver_setDifNonlinearByValue(self, value, cell, group, side, state)

    def generateAmplitudeMatrix(self):
        return _openrk.Solver_generateAmplitudeMatrix(self)
    ...
    def interpolateShape(self, state, state_forward, state_backward):
        return _openrk.Solver_interpolateShape(self, state, state_forward, state_backward)

    def interpolateDifNonlinear(self, state, state_forward, state_backward):
        return _openrk.Solver_interpolateDifNonlinear(self, state, state_forward, state_backward)

    def computeDiffusionCoefficients(self, state):
        return _openrk.Solver_computeDiffusionCoefficients(self, state)

    def reconstructFlux(self, state, state_shape, state_amp):
        return _openrk.Solver_reconstructFlux(self, state, state_shape, state_amp)

    def computeShape(self, state, state_flux, state_amp):
        return _openrk.Solver_computeShape(self, state, state_flux, state_amp)
    ...
    def copyFieldVariables(self, state_from, state_to):
        return _openrk.Solver_copyFieldVariables(self, state_from, state_to)

    def broadcastToAll(self, state_from):
        return _openrk.Solver_broadcastToAll(self, state_from)
...
class SolverDiffusion(Solver):
    ...
    def getDifLinearFine(self, state):
        return _openrk.SolverDiffusion_getDifLinearFine(self, state)

    def getDifLinearFineByValue(self, cell, group, side, state):
        return _openrk.SolverDiffusion_getDifLinearFineByValue(self, cell, group, side, state)

    def getGeometryDiffusion(self):
        return _openrk.SolverDiffusion_getGeometryDiffusion(self)

    def setDifLinearFineByValue(self, value, cell, group, side, state):
        return _openrk.SolverDiffusion_setDifLinearFineByValue(self, value, cell, group, side, state)
    ...
    def generateShapeMatrices(self, state, state_prev):
        return _openrk.SolverDiffusion_generateShapeMatrices(self, state, state_prev)

    def computeDiffusionCoefficientsFine(self, state):
        return _openrk.SolverDiffusion_computeDiffusionCoefficientsFine(self, state)

    def generateInitialShapeMatrices(self):
        return _openrk.SolverDiffusion_generateInitialShapeMatrices(self)

    def generateAmpCurrent(self, state):
        return _openrk.SolverDiffusion_generateAmpCurrent(self, state)
