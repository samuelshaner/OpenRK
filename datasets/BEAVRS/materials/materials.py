...
materials['Zircaloy'].addIsotope(isotopes['O-16'], 3.0818e-4)   # Includes O-17 and O-18 number densities
...
#materials['Air'].addIsotope(isotopes['C-12'], 6.7565e-9)   # Unavailable in cross-section library?
#materials['Air'].addIsotope(isotopes['C-13'], 7.3706e-11)    # Unavailable in cross-section library?
materials['Air'].addIsotope(isotopes['O-16'], 5.2993e-6)        # Includes O-17 and O-18 number densities
...
materials['Boro. Glass'].addIsotope(isotopes['O-16'], 4.6624e-2)   # Includes O-17 and O-18 number densities
