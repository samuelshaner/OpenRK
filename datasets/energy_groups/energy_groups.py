...
# 16-group structure
casmo['16-group'] = infermc.EnergyGroups()
group_edges = np.array([0., 0.03e-6, 0.058e-6, 0.14e-6,
...
# 18-group structure
casmo['18-group'] = infermc.EnergyGroups()
...
# 25-group structure
casmo['25-group'] = infermc.EnergyGroups()
...
# 40-group structure
casmo['40-group'] = infermc.EnergyGroups()
...
# 70-group structure
casmo['70-group'] = infermc.EnergyGroups()
...
group_edges = np.array([1.e-10, 3.e-8, 1.e-7, 3.e-7, 6.25e-7,
